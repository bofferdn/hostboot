    ...
    do
    {
        ...
        for (;l_filter;++l_filter)
        {
            ...
            else
            {
                ...
                // All array entries start right after header which is of 5 word size
                l_hostI2cFullPcrdHdrPtr->hdatOffset = sizeof(*l_hostI2cFullPcrdHdrPtr);
                ...
                l_hostI2cFullPcrdHdrPtr->hdatActSize =
                    sizeof(hdatI2cData_t);
                l_hostI2cFullPcrdHdrPtr->hdatVersion = HOST_I2C_DEV_INFO_VERSION::V2;
                ...
                sizeof(*l_hostI2cFullPcrdHdrPtr) + (sizeof(hdatI2cData_t) * HDAT_PCRD_MAX_I2C_DEV);
            ...
            this->iv_spPcrd->hdatPcrdIntData[HDAT_PCRD_DA_HOST_I2C].hdatOffset
                   +
            sizeof(hdatHDIFVersionedDataArray_t) + (sizeof(hdatI2cData_t) * HDAT_PCRD_MAX_I2C_DEV);
